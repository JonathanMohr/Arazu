...
{
    /** Allocates memory of a size in bytes and returns its pointer or ARAZU_NULL on failure */
...
/** Creates context for Arazu functions, copies arguments and returns ARAZU_NULL on failure */
