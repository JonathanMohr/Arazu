...
ARAZU_DETAIL_API Arazu_Bool Arazu_Object_Symbol_Create(
...
/** Copy symbol */
ARAZU_DETAIL_API Arazu_Bool Arazu_Object_Symbol_Copy(Arazu_Object_Symbol* out, const Arazu_Context* newCtx, const Arazu_Object_Symbol* original);


/** Get value */
ARAZU_DETAIL_API Arazu_uValue Arazu_Object_Symbol_GetValue(const Arazu_Context* ctx, const Arazu_Object_Symbol* symbol);

/** Get name */
ARAZU_DETAIL_API Arazu_String Arazu_Object_Symbol_GetName(const Arazu_Context* ctx, const Arazu_Object_Symbol* symbol);

/** Get section name */
ARAZU_DETAIL_API Arazu_String Arazu_Object_Symbol_GetSectionName(const Arazu_Context* ctx, const Arazu_Object_Symbol* symbol);

/** Get state */
ARAZU_DETAIL_API Arazu_Object_Symbol_State Arazu_Object_Symbol_GetState(const Arazu_Context* ctx, const Arazu_Object_Symbol* symbol);

/** Get visibility */
ARAZU_DETAIL_API Arazu_Object_Symbol_Visibility Arazu_Object_Symbol_GetVisibility(const Arazu_Context* ctx, const Arazu_Object_Symbol* symbol);

/** Check if it has debug information */
ARAZU_DETAIL_API Arazu_Bool Arazu_Object_Symbol_HasDebugInformation(const Arazu_Context* ctx, const Arazu_Object_Symbol* symbol);
